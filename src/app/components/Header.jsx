...
export default function Header() {
    return (
        <>
            <header className="flex mb-20 bg-primary justify-between shadow-md max-md:flex-col">
                ...
                <nav className={"flex p-5 justify-center gap-5 w-[50%] font-bold max-md:w-[100vw] max-md:p-5"}>
                    ...
                    <Link href={"/cart"} className={"flex items-center justify-center bg-secondary px-3 py-2 rounded-md w-20 hover:bg-accent"}>cart</Link>
                </nav>
            </header>
        </>
    );
